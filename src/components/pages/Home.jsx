...
const Home = () => {
  ...
  return (
    <div className="w-5/6 min-h-screen bg-red-500/10 flex flex-col gap-10">
        ...
        <div className='w-10/11 h-11/12 rounded-xl overflow-hidden'>
          <div className='w-[75.1vw] h-[73.4vh] absolute z-20 rounded-xl flex bg-black/60'>
            ...
            <div className='w-1/2 h-full flex place-items-end justify-center'>
              ...
              <div className='max-w-9/12 h-1/5 backdrop-blur-2xl bg-black/30 rounded-2xl flex gap-4 overflow-x-auto p-4 scrollbar scroll-smooth relative -top-3'>
      ...
      <div className='w-10/11 h-100 bg-red-300'>
