    ...
    <>
      <Link to="" className='w-full h-12 flex justify-center'>
         ...
         className='w-full h-full flex items-center gap-4 hover:bg-gray-300/20'>
          <div className={clicked_now ? `w-[.2em] h-full bg-fuchsia-500 rounded-e-2xl`: 'w-[.3em] h-full rounded-e-2xl'}></div>
          <div className='w-7/9 h-full flex items-center gap-3'>
          <div className= {clicked_now ? 'w-10 h-10 flex items-center justify-center text-fuchsia-500 transition duration-150': 'w-10 h-10 flex items-center justify-center text-white/30 transition duration-150' } >{ icon }</div>
